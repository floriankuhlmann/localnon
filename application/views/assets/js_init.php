<?php header("Content-type: application/javascript; charset: UTF-8", true); ?>
function geoFindMe() {
 			/*alert('granting access');	
  			$('#longitude').val(13.4022454);
    		$('#latitude').val(52.5394512);
    		$('#loginform').submit();
  			*/
  			...
  			function success(position) {
        		// position bestimmen und weiter zum login  		
				// alert ("longitude:"+position.coords.longitude+" and latitude:"+position.coords.latitude);
    			$('#longitude').val(position.coords.longitude+321);
    			$('#latitude').val(position.coords.latitude+321);		
    			$('#loginform').submit();
  			...
  			// running the stuff
  			square.play();
			output.innerHTML = "Locating…<br>";
			output.appendChild(square.canvas);
